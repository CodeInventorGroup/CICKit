#
#  Be sure to run `pod spec lint CICKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "sytnewworld" => "sytnewworld@gmail.com", "ManoBoo" => "manoboo@icloud.com" }
  ...
  s.source       = { :git => "https://github.com/CodeInventorGroup/CICKit.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "CIComponentKit", "CIComponentKit/**/*.{h,m}"
